...
@WebServiceClient(name = "PerSecurityWS", 
                  wsdlLocation = "file:/C:/develop/TRADE_5_DEV_2014_JBOSS/bbws/dlws/config/Bloomberg-DLWS.wsdl",
...
public class PerSecurityWS_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/develop/TRADE_5_DEV_2014_JBOSS/bbws/dlws/config/Bloomberg-DLWS.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PerSecurityWS_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/develop/TRADE_5_DEV_2014_JBOSS/bbws/dlws/config/Bloomberg-DLWS.wsdl");
        }
        WSDL_LOCATION = url;
    }
